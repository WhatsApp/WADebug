...
def test_should_return_filepath_string_if_get_container_logs_has_no_exceptions(mocker):
    ...
    mocker.patch.object(docker_utils, "write_to_file_in_binary", return_value=None)
    mocker.patch.object(path, "join", return_value=expected_container_logs_filepath)
    try:
...
def test_should_return_filepath_string_if_get_container_inspect_logs_has_no_exceptions(
    ...
    mocker.patch.object(docker_utils, "write_to_file", return_value=None)
    mocker.patch.object(path, "join", return_value=expected_inspect_log_filepath)
    try:
...
def test_should_return_filepath_string_if_get_corecontainer_coredumps_logs_has_no_exceptions(
    ...
    mocker.patch.object(docker_utils, "write_to_file", return_value=None)
    mocker.patch.object(path, "join", return_value=expected_coredump_log_filepath)
    try:
...
def test_should_return_list_of_filepaths_for_logs_if_get_logs_has_no_exceptions(mocker):
    mock_containers = [docker_utils.WAContainer(MockContainer(), "container_type")]
    mocker.patch.object(docker_utils, "get_wa_containers", return_value=mock_containers)
    mocker.patch.object(log_utils, "get_container_logs", return_value="/container/logs")
    mocker.patch.object(
