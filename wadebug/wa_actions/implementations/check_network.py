...
HOSTS_USING_DEFAULT_PORT = [("g.whatsapp.net", WA_SERVER_TYPE.WA_SERVER)]
...
def is_server_in_warning_state(container, hostname):
    not_reachable_on_default_port = network_utils.hostname_not_reachable_from_container(
        container, hostname, DEFAULT_PORT, CONNECTION_TIMEOUT
    )

    reachable_on_https_port = network_utils.hostname_reachable_from_container(
...
def is_server_in_error_state(container, hostname):
    not_reachable_on_https_port = network_utils.hostname_not_reachable_from_container(
        container, hostname, HTTPS_PORT, CONNECTION_TIMEOUT
    )
