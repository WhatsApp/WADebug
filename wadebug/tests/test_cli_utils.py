...
class TestSendResultsToFB:
    def test_should_append_run_id_to_result_if_succeed(self, mocker):
        ...
        mocker.patch.object(Analytics, "send_event", return_value=mock_run_id)
    ...
    def test_should_call_failure_callback_with_exception(self, mocker):
        ...
        mocker.patch.object(Analytics, "send_event", side_effect=mock_exception)
...
class TestSendLogsToFB:
    def test_should_call_success_callback_with_run_id(self, mocker):
        ...
        mocker.patch.object(Analytics, "send_logs_to_fb", return_value=mock_run_id)
    ...
    def test_should_call_failure_callback_with_exception(self, mocker):
        ...
        mocker.patch.object(Analytics, "send_logs_to_fb", side_effect=mock_exception)
